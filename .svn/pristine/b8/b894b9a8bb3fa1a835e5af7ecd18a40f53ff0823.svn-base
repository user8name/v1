...
class es_cls_registerhook {
	...
	public static function es_update_footer_text($es_text) {
		...
		$es_plugin_data = get_plugin_data( WP_PLUGIN_DIR.'/email-subscribers-plus/email-subscribers-plus.php' );
...
class es_widget_register extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['es_desc']    = ( ! empty( $new_instance['es_desc'] ) ) ?  $new_instance['es_desc'] : '';
