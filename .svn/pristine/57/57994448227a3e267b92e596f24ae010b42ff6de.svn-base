...
if (!function_exists('DbHelper')) {
	...
	function &DbHelper($dbid = "") {
		$dbclass = "cmatexcel_db";
		$dbhelper = new $dbclass();
		return $dbhelper;
	}
}

class cmatexcel_db extends cDbHelper {

	// Database connection info
	var $Host = 'cddbmysql.c8qakfd9b1ln.us-west-1.rds.amazonaws.com';
	var $Port = 3306;
	var $Username = 'matexcel';
	var $Password = 'Y6HKd8BrWVpkEyFK';
	var $DbName = 'matexcel';
