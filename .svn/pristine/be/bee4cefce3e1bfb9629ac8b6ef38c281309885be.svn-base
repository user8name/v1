...
define("EW_DEFAULT_DATE_FORMAT_ID", "15", TRUE); // Default date format
define("EW_DATE_SEPARATOR", "-", TRUE); // Date separator
define("EW_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("EW_PROJECT_NAME", "matexcel", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{2ACFE866-F5EE-4BCB-8DD0-02E059CEE335}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'drXZQjaQMPxkXs9f', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/matexcel.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "cddbmysql.c8qakfd9b1ln.us-west-1.rds.amazonaws.com", "port" => 3306, "user" => "matexcel", "pass" => "Y6HKd8BrWVpkEyFK", "db" => "matexcel", "qs" => "`", "qe" => "`");
...
$EW_XSS_ARRAY = array('javascript', 'vbscript', '<applet', '<meta', '<xml', '<blink', '<link', '<style', '<script', '<embed', '<object', '<iframe', '<frame', '<frameset', '<ilayer', '<layer', '<bgsound', '<title', '<base',
...
define("EW_UPLOAD_DEST_PATH", "wp-tasks/", TRUE); // Upload destination path (relative to app root)
